...
sed -i -- "s/__NODE_NAME__/$HOSTNAME/g" /root/consul-bootstrap-server-agent/config.json
sed -i -- "s/__ENCRYPT__/$ENCRYPT/g" /root/consul-bootstrap-server-agent/config.json
sed -i -- "s/__BOOTSTRAP_PRIVATE_IP__/$PRIVATE_IP1/g" /root/consul-bootstrap-server-agent/config.json
sed -i -- "s/__NON_BOOTSTRAP_PRIVATE_IP__/$PRIVATE_IP2/g" /root/consul-bootstrap-server-agent/config.json
